...
//Map through data to get ALL the info
//like reactstudents' app.js map method
//import data from data and ONLY display the name, symbol, price and change ONLY on the Dashboard component
//Link the other information to the SYMBOL so that when users click on the symbol, it leads to this info: high, low and open ONLY.

//how to get the value of change?
//when get value, test if it begins with -
//if it begins with -, change color to red
//or just get the index of change value and make red in css
